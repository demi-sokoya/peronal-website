...
// 📘 No data imports needed — the playlist is an embedded iframe.
//    Replace PLAYLIST_ID in the src URL with your actual Spotify playlist ID.
//    Find it in the share URL: open.spotify.com/playlist/PLAYLIST_ID
